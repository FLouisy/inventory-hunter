(function(g){var window=this;var UHa=function(a,b){return g.Lb(a,b)},w4=function(a,b,c){a.l.set(b,c)},x4=function(a){w4(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^g.Sa()).toString(36));
return a},y4=function(a,b,c){Array.isArray(c)||(c=[String(c)]);
g.bn(a.l,b,c)},VHa=function(a,b){var c=[];
...
g.Ab(c,function(d){g.Pn.prototype.remove.call(this,d)},a)},XHa=function(a){if(a.W){if(a.W.locationOverrideToken)return{locationOverrideToken:a.W.locationOverrideToken};
if(null!=a.W.latitudeE7&&null!=a.W.longitudeE7)return{latitudeE7:a.W.latitudeE7,longitudeE7:a.W.longitudeE7}}return null},YHa=function(a,b){g.fb(a,b)||a.push(b)},z4=function(a){var b=0,c;
for(c in a)b++;return b},ZHa=function(a,b){var c=b instanceof g.Fc?b:g.Lc(b,/^data:image\//i.test(b));
a.src=g.Gc(c)},A4=function(){},$Ha=function(a){try{return g.A.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},aIa=function(a){if(a.sg&&"function"==typeof a.sg)return a.sg();
if("string"===typeof a)return a.split("");if(g.Ma(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return g.Ib(a)},bIa=function(a,b){if(a.forEach&&"function"==typeof a.forEach)a.forEach(b,void 0);
else if(g.Ma(a)||"string"===typeof a)g.Ab(a,b,void 0);else{if(a.rh&&"function"==typeof a.rh)var c=a.rh();else if(a.sg&&"function"==typeof a.sg)c=void 0;else if(g.Ma(a)||"string"===typeof a){c=[];for(var d=a.length,e=0;e<d;e++)c.push(e)}else c=g.Jb(a);d=aIa(a);e=d.length;for(var f=0;f<e;f++)b.call(void 0,d[f],c&&c[f],a)}},cIa=function(a,b,c,d){var e=new g.Qm(null,void 0);
...
this.type="REMOTE_CONTROL";this.obfuscatedGaiaId=this.avatar=this.username="";this.capabilities=new Set;this.experiments=new Set;this.theme="u";new g.Nm;a&&(this.id=a.id||a.name,this.name=a.name,this.app=a.app,this.type=a.type||"REMOTE_CONTROL",this.username=a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",dIa(this,a.capabilities||""),eIa(this,a.experiments||""))},dIa=function(a,b){a.capabilities.clear();
g.Me(b.split(","),g.Qa(UHa,fIa)).forEach(function(c){a.capabilities.add(c)})},eIa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},D4=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},E4=function(a,b){return!!b&&(a.id==b||a.uuid==b)},gIa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},hIa=function(a){return new D4(a)},iIa=function(a){return Array.isArray(a)?g.Pc(a,hIa):[]},F4=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},G4=function(a){return Array.isArray(a)?"["+g.Pc(a,F4).join(",")+"]":"null"},H4=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},jIa=function(a){return g.Pc(a,function(b){return{key:b.id,
name:b.name}})},I4=function(a,b){return g.cb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},J4=function(a,b){return g.cb(a,function(c){return E4(c,b)})},kIa=function(){var a=(0,g.Cu)();
a&&WHa(a,a.i.Pj(!0))},K4=function(){var a=g.Fu("yt-remote-connected-devices")||[];
g.xb(a);return a},lIa=function(a){if(g.gb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.Pc(a,function(d,e){return 0==e?d:d.substring(c.length)})},mIa=function(a){g.Eu("yt-remote-connected-devices",a,86400)},M4=function(){if(L4)return L4;
...
g.fb(a,b);g.Hu()&&g.zb(a,b);a=lIa(a);if(g.gb(a))try{g.Tq("remote_sid")}catch(c){}else try{g.Rq("remote_sid",a.join(","),-1)}catch(c){}},nIa=function(){return g.Fu("yt-remote-session-browser-channel")},oIa=function(){return g.Fu("yt-remote-local-screens")||[]},pIa=function(){g.Eu("yt-remote-lounge-token-expiration",!0,86400)},qIa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.Pc(oIa(),function(d){return d.loungeToken}),c=g.Pc(a,function(d){return d.loungeToken});
g.ph(c,function(d){return!g.fb(b,d)})&&pIa();
g.Eu("yt-remote-local-screens",a,31536E3)},rIa=function(a,b){g.Eu("yt-remote-session-browser-channel",a);
g.Eu("yt-remote-session-screen-id",b);var c=K4(),d=M4();g.fb(c,d)||c.push(d);mIa(c);N4()},O4=function(a){a||(g.Gu("yt-remote-session-screen-id"),g.Gu("yt-remote-session-video-id"));
N4();a=K4();g.kb(a,M4());mIa(a)},sIa=function(){if(!P4){var a=g.go();
a&&(P4=new g.Jn(a))}},tIa=function(){sIa();
return P4?!!P4.get("yt-remote-use-staging-server"):!1},Q4=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},uIa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},vIa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},R4=function(a){a.length?wIa(a.shift(),function(){R4(a)}):S4()},xIa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},wIa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.md(d,g.pg(a));(document.head||document.documentElement).appendChild(d)},yIa=function(){var a=Q4(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},S4=function(){var a=vIa();
a&&a(!1,"No cast extension found")},T4=function(){if(zIa){var a=2,b=vIa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;wIa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",S4,c)}},AIa=function(){T4();
var a=yIa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");R4(a)},CIa=function(){T4();
var a=yIa();a.push.apply(a,g.la(BIa.map(xIa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");R4(a)},U4=function(a,b,c){g.E.call(this);
...
var b=a.u;a.u=null;a.B.apply(null,b)},X4=function(a){if(g.A.JSON)try{return g.A.JSON.parse(a)}catch(b){}return $Ha(a)},Y4=function(){},Z4=function(a,b){if("function"!==typeof a)throw Error("Fn must not be null and must be a function");
return g.A.setTimeout(function(){a()},b)},a5=function(a){$4.dispatchEvent(new DIa($4,a))},DIa=function(a,b){g.Hl.call(this,"statevent",a);
this.stat=b},b5=function(){},EIa=function(){},GIa=function(a){return(a=FIa(a))?new ActiveXObject(a):new XMLHttpRequest},FIa=function(a){if(!a.l&&"undefined"==typeof XMLHttpRequest&&"undefined"!=typeof ActiveXObject){for(var b=["MSXML2.XMLHTTP.6.0",
...
this.l=b;this.L=c;this.J=d||1;this.C=45E3;this.B=new g.w_(this);this.u=new g.Km;this.u.setInterval(250)},IIa=function(a,b,c){a.Dp=1;
a.Uk=x4(b.clone());a.zn=c;a.I=!0;HIa(a,null)},d5=function(a,b,c,d,e){a.Dp=1;
a.Uk=x4(b.clone());a.zn=null;a.I=c;e&&(a.JG=!1);HIa(a,d)},HIa=function(a,b){a.rp=g.Sa();
e5(a);a.Pl=a.Uk.clone();y4(a.Pl,"t",a.J);a.Ds=0;a.De=a.i.xx(a.i.Yr()?b:null);0<a.tw&&(a.Pu=new V4((0,g.B)(a.GH,a,a.De),a.tw));a.B.ya(a.De,"readystatechange",a.ZP);var c=a.jm?g.Ub(a.jm):{};a.zn?(a.Cv="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.De.send(a.Pl,a.Cv,a.zn,c)):(a.Cv="GET",a.JG&&!g.Ce&&(c.Connection="close"),a.De.send(a.Pl,a.Cv,null,c));a.i.ii(1)},LIa=function(a,b,c){for(var d=!0;!a.Jm&&a.Ds<c.length;){var e=JIa(a,c);
if(e==f5){4==b&&(a.Ok=4,a5(15),d=!1);break}else if(e==KIa){a.Ok=4;a5(16);d=!1;break}else g5(a,e)}4==b&&0==c.length&&(a.Ok=1,a5(17),d=!1);a.yi=a.yi&&d;d||(h5(a),i5(a))},JIa=function(a,b){var c=a.Ds,d=b.indexOf("\n",c);
if(-1==d)return f5;c=Number(b.substring(c,d));if(isNaN(c))return KIa;d+=1;if(d+c>b.length)return f5;var e=b.substr(d,c);a.Ds=d+c;return e},NIa=function(a,b){a.rp=g.Sa();
e5(a);var c=b?window.location.hostname:"";a.Pl=a.Uk.clone();w4(a.Pl,"DOMAIN",c);w4(a.Pl,"t",a.J);try{a.Ci=new ActiveXObject("htmlfile")}catch(n){h5(a);a.Ok=7;a5(22);i5(a);return}var d="<html><body>";if(b){for(var e="",f=0;f<c.length;f++){var h=c.charAt(f);if("<"==h)h=e+"\\x3c";else if(">"==h)h=e+"\\x3e";else{if(h in j5)h=j5[h];else if(h in MIa)h=j5[h]=MIa[h];else{var l=h.charCodeAt(0);if(31<l&&127>l)var m=h;else{if(256>l){if(m="\\x",16>l||256<l)m+="0"}else m="\\u",4096>l&&(m+="0");m+=l.toString(16).toUpperCase()}h=
...
a.C;
OIa(a,a.C)},OIa=function(a,b){if(null!=a.Jp)throw Error("WatchDog timer not null");
...
g.Oi(a.Pu);a.Pu=null;a.u.stop();g.oCa(a.B);if(a.De){var b=a.De;a.De=null;b.abort();b.dispose()}a.Ci&&(a.Ci=null)},g5=function(a,b){try{a.i.KF(a,b),a.i.ii(4)}catch(c){}},QIa=function(a,b,c,d,e){if(0==d)c(!1);
...
ZHa(d,a)},l5=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},m5=function(a){g.am.call(this);
this.headers=new g.Nm;this.ea=a||null;this.B=!1;this.ca=this.i=null;this.za=this.W="";this.I=0;this.u="";this.C=this.la=this.L=this.ga=!1;this.J=0;this.X=null;this.Ca="";this.Y=this.ia=!1},RIa=function(a){return g.Ae&&g.ae(9)&&"number"===typeof a.timeout&&void 0!==a.ontimeout},SIa=function(a){return"content-type"==a.toLowerCase()},UIa=function(a,b){a.B=!1;
a.i&&(a.C=!0,a.i.abort(),a.C=!1);a.u=b;a.I=5;TIa(a);n5(a)},TIa=function(a){a.ga||(a.ga=!0,a.dispatchEvent("complete"),a.dispatchEvent("error"))},WIa=function(a){if(a.B&&"undefined"!=typeof g.z_)if(a.ca[1]&&4==o5(a)&&2==a.getStatus())p5(a,"Local request error detected and ignored");
else if(a.L&&4==o5(a))g.Lm(a.HF,0,a);else if(a.dispatchEvent("readystatechange"),a.isComplete()){p5(a,"Request complete");a.B=!1;try{var b=a.getStatus();a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break a;default:c=!1}var d;if(!(d=c)){var e;if(e=0===b){var f=g.Ad(1,String(a.W));if(!f&&g.A.self&&g.A.self.location){var h=g.A.self.location.protocol;f=h.substr(0,h.length-1)}e=!VIa.test(f?f.toLowerCase():"")}d=e}if(d)a.dispatchEvent("complete"),a.dispatchEvent("success");
else{a.I=6;try{var l=2<o5(a)?a.i.statusText:""}catch(m){l=""}a.u=l+" ["+a.getStatus()+"]";TIa(a)}}finally{n5(a)}}},n5=function(a,b){if(a.i){XIa(a);
...
a.X&&(g.A.clearTimeout(a.X),a.X=null)},o5=function(a){return a.i?a.i.readyState:0},q5=function(a){try{return a.i?a.i.responseText:""}catch(b){return""}},p5=function(a,b){return b+" ["+a.za+" "+a.W+" "+a.getStatus()+"]"},YIa=function(a){this.i=a;
this.l=new Y4},ZIa=function(a){var b=r5(a.i,a.kq,"/mail/images/cleardot.gif");
x4(b);QIa(b.toString(),5E3,(0,g.B)(a.AK,a),3,2E3);a.ii(1)},t5=function(a){var b=a.i.L;
if(null!=b)a5(5),b?(a5(11),s5(a.i,a,!1)):(a5(12),s5(a.i,a,!0));else if(a.Cg=new c5(a,void 0,void 0,void 0),a.Cg.jm=a.uw,b=a.i,b=r5(b,b.Yr()?a.aq:null,a.ww),a5(5),!g.Ae||g.ce(10))y4(b,"TYPE","xmlhttp"),d5(a.Cg,b,!1,a.aq,!1);else{y4(b,"TYPE","html");var c=a.Cg;a=!!a.aq;c.Dp=3;c.Uk=x4(b.clone());NIa(c,a)}},u5=function(a,b,c){this.Ma=1;
this.i=[];this.u=[];this.B=new Y4;this.J=a||null;this.L=null!=b?b:null;this.C=c||!1},$Ia=function(a,b){this.i=a;
this.map=b;this.context=null},aJa=function(a,b,c,d){g.Hl.call(this,"timingevent",a);
this.size=b;this.Rr=d},bJa=function(a){g.Hl.call(this,"serverreachability",a)},eJa=function(a){cJa(a);
if(3==a.Ma){var b=a.yr++,c=a.xt.clone();w4(c,"SID",a.l);w4(c,"RID",b);w4(c,"TYPE","terminate");v5(a,c);b=new c5(a,a.l,b,void 0);b.Dp=2;b.Uk=x4(c.clone());ZHa(new Image,b.Uk.toString());b.rp=g.Sa();e5(b)}dJa(a)},fJa=function(a){a.UK(1,0);
a.xt=r5(a,null,a.xw);w5(a)},cJa=function(a){a.Yk&&(a.Yk.abort(),a.Yk=null);
a.Zd&&(a.Zd.cancel(),a.Zd=null);a.Qj&&(g.A.clearTimeout(a.Qj),a.Qj=null);x5(a);a.pg&&(a.pg.cancel(),a.pg=null);a.kl&&(g.A.clearTimeout(a.kl),a.kl=null)},gJa=function(a,b){if(0==a.Ma)throw Error("Invalid operation: sending map when state is closed");
a.i.push(new $Ia(a.rM++,b));2!=a.Ma&&3!=a.Ma||w5(a)},hJa=function(a){var b=0;
a.Zd&&b++;a.pg&&b++;return b},w5=function(a){a.pg||a.kl||(a.kl=Z4((0,g.B)(a.RF,a),0),a.yo=0)},jJa=function(a,b){if(1==a.Ma){if(!b){a.yr=Math.floor(1E5*Math.random());
var c=a.yr++,d=new c5(a,"",c,void 0);d.jm=a.Ii;var e=y5(a),f=a.xt.clone();w4(f,"RID",c);w4(f,"CVER","1");v5(a,f);IIa(d,f,e);a.pg=d;a.Ma=2}}else 3==a.Ma&&(b?iJa(a,b):0==a.i.length||a.pg||iJa(a))},iJa=function(a,b){if(b)if(6<a.Km){a.i=a.u.concat(a.i);
a.u.length=0;var c=a.yr-1;var d=y5(a)}else c=b.L,d=b.zn;else c=a.yr++,d=y5(a);var e=a.xt.clone();w4(e,"SID",a.l);w4(e,"RID",c);w4(e,"AID",a.So);v5(a,e);c=new c5(a,a.l,c,a.yo+1);c.jm=a.Ii;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.pg=c;IIa(c,e,d)},v5=function(a,b){if(a.yf){var c=a.yf.rD();
...
return c.join("&")},kJa=function(a){a.Zd||a.Qj||(a.I=1,a.Qj=Z4((0,g.B)(a.QF,a),0),a.fo=0)},z5=function(a){if(a.Zd||a.Qj||3<=a.fo)return!1;
a.I++;a.Qj=Z4((0,g.B)(a.QF,a),lJa(a,a.fo));a.fo++;return!0},s5=function(a,b,c){a.Av=c;
a.Ji=b.Nj;a.C||fJa(a)},x5=function(a){null!=a.Rm&&(g.A.clearTimeout(a.Rm),a.Rm=null)},lJa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},A5=function(a,b){if(2==b||9==b){var c=null;
a.yf&&(c=null);var d=(0,g.B)(a.HQ,a);c||(c=new g.Qm("//www.google.com/images/cleardot.gif"),x4(c));PIa(c.toString(),1E4,d)}else a5(2);mJa(a,b)},mJa=function(a,b){a.Ma=0;
a.yf&&a.yf.HC(b);dJa(a);cJa(a)},dJa=function(a){a.Ma=0;
...
if(""!=d.i)b&&g.Sm(d,b+"."+d.i),g.Tm(d,d.u);else{var e=window.location;d=cIa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.Eq&&g.Cb(a.Eq,function(f,h){w4(d,h,f)});
w4(d,"VER",a.Km);v5(a,d);return d},nJa=function(){},oJa=function(){this.i=[];
this.l=[]},pJa=function(a,b){this.action=a;
...
e=void 0===e?!1:e;this.ca=a;this.I=b;this.u=new g.In;this.l=new B5(this.jQ,this);this.i=null;this.X=!1;this.C=null;this.W="";this.L=this.B=0;this.J=[];this.ea=c;this.Y=d;this.ia=e},qJa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.Av,sessionId:a.i.l,arrayId:a.i.So}},rJa=function(a,b){a.L=b||0;
a.l.stop();D5(a);a.i&&(3==a.i.getState()&&jJa(a.i),eJa(a.i));a.L=0},E5=function(a){return!!a.i&&3==a.i.getState()},D5=function(a){if(a.i){var b=a.Y(),c=a.i.Ii||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Qa(a.B,d,!0),onError:g.Qa(a.u,e),onTimeout:g.Qa(a.C,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.Yp(b,a)},vJa=function(){var a=sJa;
tJa();I5.push(a);uJa()},J5=function(a,b){tJa();
var c=wJa(a,String(b));g.gb(I5)?xJa(c):(uJa(),g.Ab(I5,function(d){d(c)}))},tJa=function(){I5||(I5=g.Ha("yt.mdx.remote.debug.handlers_")||[],g.Da("yt.mdx.remote.debug.handlers_",I5,void 0))},xJa=function(a){var b=(K5+1)%50;
K5=b;L5[b]=a;M5||(M5=49==b)},uJa=function(){var a=I5;
if(L5[0]){var b=M5?K5:-1;do{b=(b+1)%50;var c=L5[b];g.Ab(a,function(d){d(c)})}while(b!=K5);
L5=Array(50);K5=-1;M5=!1}},wJa=function(a,b){var c=(g.Sa()-yJa)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},N5=function(a){g.R.call(this);
this.I=a;this.screens=[]},zJa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
...
this.l=a;this.i=NaN;P5(this);this.info("Initializing with "+G4(this.screens))},CJa=function(a){if(a.screens.length){var b=g.Pc(a.screens,function(d){return d.id}),c=G5(a.l,"/pairing/get_lounge_token_batch");
H5(a.l,c,{screen_ids:b.join(",")},(0,g.B)(a.vL,a),(0,g.B)(a.uL,a))}},P5=function(a){if(g.Po("deprecate_pair_servlet_enabled"))return AJa(a,[]);
var b=iIa(oIa());b=g.Me(b,function(c){return!c.uuid});
return AJa(a,b)},R5=function(a,b){qIa(g.Pc(a.screens,gIa));
b&&pIa()},T5=function(a,b){g.R.call(this);
...
else{c=g.Jb(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(S5("Updated online screens: "+g.Pj(a.i)),a.i=b,a.V("screenChange"));DJa(a)},W5=function(a){isNaN(a.u)||g.Bo(a.u);
a.u=g.zo((0,g.B)(a.Hz,a),0<a.B&&a.B<g.Sa()?2E4:1E4)},S5=function(a){J5("OnlineScreenService",a)},EJa=function(a){var b={};
g.Ab(a.I(),function(c){c.token?b[c.token]=c.id:this.Fd("Requesting availability of screen w/o lounge token.")});
return b},DJa=function(a){a=g.Jb(g.Db(a.i,function(b){return b}));
...
c||(c=a.C[b]);var h=a.Pg();if(h=(c?J4(h,c):null)||J4(h,b)){h.uuid=b;var l=Y5(a,h);U5(a.i,l,function(m){e(m?l:null)})}else c?GJa(a,c,(0,g.B)(function(m){var n=Y5(this,new D4({name:d,
screenId:c,loungeToken:m,dialId:b||""}));U5(this.i,n,function(p){e(p?n:null)})},a),f):e(null)},IJa=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},JJa=function(a,b,c){U5(a.i,b,c)},GJa=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.Yp(G5(a.B,"/pairing/get_lounge_token_batch"),e)},KJa=function(a){a.screens=a.l.Pg();
var b=a.C,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+G4(a.screens))},FJa=function(a){Z5(a);
a.l=new Q5(a.B);a.l.subscribe("screenChange",(0,g.B)(a.BL,a));KJa(a);a.u=iIa(g.Fu("yt-remote-automatic-screen-cache")||[]);Z5(a);a.info("Initializing automatic screens: "+G4(a.u));a.i=new T5(a.B,(0,g.B)(a.Pg,a,!0));a.i.subscribe("screenChange",(0,g.B)(function(){this.V("onlineScreenChange")},a))},Y5=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=J4(a.u,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.u.push(b),LJa(a));Z5(a);a.C[b.uuid]=b.id;g.Eu("yt-remote-device-id-map",a.C,31536E3);return b},LJa=function(a){a=g.Me(a.u,function(b){return"shortLived"!=b.idType});
g.Eu("yt-remote-automatic-screen-cache",g.Pc(a,gIa))},Z5=function(a){a.C=g.Fu("yt-remote-device-id-map")||{}},$5=function(a,b,c){g.R.call(this);
...
var d=this;this.ga=c;this.l=null;this.Y=(0,g.B)(this.OJ,this);this.ca=(0,g.B)(this.GP,this);this.X=g.zo(function(){MJa(d,null)},12E4);
...
g.Bo(a.C);a.C=g.zo(function(){PJa(a,null)},3E4)},OJa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.Pj(void 0));
var c={};c.type=b;a.l?a.l.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ia,(0,g.B)(function(){b6(this,"Failed to send message: "+b+".")},a)):b6(a,"Sending yt message without session: "+g.Pj(c))},e6=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.ID(b,function(c){a6(a,c)},function(){return a.cg()},5)):a.cg(Error("Waiting for session status timed out."))},RJa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new D4(b);QJa(a,d,function(e){e?(a.ea=!0,Y5(a.u,d),a6(a,d),a.W="unknown",d6(a,c)):(g.wo(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.cg())},5)},MJa=function(a,b){g.Bo(a.X);
...
e6(a,b.screenId)):e6(a,b.screenId):a.cg(Error("Waiting for session status timed out."))},PJa=function(a,b){g.Bo(a.C);
...
a.I=0;JJa(a.u,b,function(e){e||0>d?c(e):a.I=g.zo(function(){QJa(a,b,c,d-1)},300)})},SJa=function(a){g.Bo(a.L);
a.L=0;g.Bo(a.I);a.I=0;g.Bo(a.X);a.X=0;g.Bo(a.C);a.C=0;g.Bo(a.J);a.J=0},f6=function(a,b,c,d){$5.call(this,a,b,"DialSession");
this.ea=d;this.l=this.J=null;this.X="";this.ga=c;this.ca=null;this.W=g.Ia;this.L=NaN;this.Y=(0,g.B)(this.PJ,this);this.C=g.Ia;this.I=0},TJa=function(a){var b;
return!!(a.ea.enableDialLoungeToken&&(null==(b=a.l)?0:b.getDialAppInfo))},UJa=function(a){a.C=a.u.IB(a.X,a.i.label,a.i.friendlyName,TJa(a),function(b){a.C=g.Ia;
a6(a,b)},function(b){a.C=g.Ia;
a.cg(b)})},VJa=function(a){var b={};
b.pairingCode=a.X;b.theme=a.ga;tIa()&&(b.env_useStageMdx=1);return g.Ld(b)},g6=function(a){return new Promise(function(b){a.X=H4();
if(a.ca){var c=new chrome.cast.DialLaunchResponse(!0,VJa(a));b(c);UJa(a)}else a.W=function(){g.Bo(a.L);a.W=function(){};
a.L=NaN;var d=new chrome.cast.DialLaunchResponse(!0,VJa(a));b(d);UJa(a)},a.L=g.zo(function(){a.W()},100)})},XJa=function(a,b){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var c=new D4(b);return(new Promise(function(d){WJa(a,c,function(e){e?(Y5(a.u,c),a6(a,c)):g.wo(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));d(e)},5)})).then(function(d){return d?new chrome.cast.DialLaunchResponse(!1):g6(a)})},YJa=function(a,b){var c=a.J.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){HJa(a.u,c,b,d,function(f){f&&f.token&&a6(a,f);e(f)},function(f){b6(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):g6(a)})},WJa=function(a,b,c,d){g.Bo(a.I);
a.I=0;JJa(a.u,b,function(e){e||0>d?c(e):a.I=g.zo(function(){WJa(a,b,c,d-1)},300)})},ZJa=function(a){g.Bo(a.I);
...
this.B=b;this.l=a;this.L=b.appId||"233637DE";this.C=b.theme||"cl";this.W=b.disableCastApi||!1;this.i=null;this.J=!1;this.u=[];this.I=(0,g.B)(this.BO,this)},$Ja=function(a,b){return b?g.cb(a.u,function(c){return E4(b,c.label)},a):null},j6=function(a){J5("Controller",a)},sJa=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},k6=function(a){return a.J||!!a.u.length||!!a.i},l6=function(a,b,c){b!=a.i&&(g.Oi(a.i),(a.i=b)?(c?a.V("yt-remote-cast2-receiver-resumed",
b.i):a.V("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.B)(a.OF,a,b)),b.getScreen()?a.V("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.To(null)):a.V("yt-remote-cast2-session-change",null))},aKa=function(a){var b=a.l.HB(),c=a.i&&a.i.i;
a=g.Pc(b,function(d){c&&E4(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=$Ja(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},fKa=function(a,b,c,d){d.disableCastApi?m6("Cannot initialize because disabled by Mdx config."):bKa()?cKa(b,d)&&(n6(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?dKa(a,c):(window.__onGCastApiAvailable=function(e,f){e?dKa(a,c):(o6("Failed to load cast API: "+f),p6(!1),n6(!1),g.Gu("yt-remote-cast-available"),g.Gu("yt-remote-cast-receiver"),
eKa(),c(!1))},d.loadCastApiSetupScript?g.Lo("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=Q4()&&AIa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?S4():89<=Q4()?CIa():(T4(),R4(BIa.map(xIa))))):m6("Cannot initialize because not running Chrome")},eKa=function(){m6("dispose");
var a=q6();a&&a.dispose();g.Da("yt.mdx.remote.cloudview.instance_",null,void 0);gKa(!1);g.Ho(r6);r6.length=0},s6=function(){return!!g.Fu("yt-remote-cast-installed")},hKa=function(){var a=g.Fu("yt-remote-cast-receiver");
return a?a.friendlyName:null},iKa=function(){m6("clearCurrentReceiver");
g.Gu("yt-remote-cast-receiver")},jKa=function(){return s6()?q6()?q6().getCastSession():(o6("getCastSelector: Cast is not initialized."),null):(o6("getCastSelector: Cast API is not installed!"),null)},u6=function(){s6()?q6()?t6()?(m6("Requesting cast selector."),q6().requestSession()):(m6("Wait for cast API to be ready to request the session."),r6.push(g.Go("yt-remote-cast2-api-ready",u6))):o6("requestCastSelector: Cast is not initialized."):o6("requestCastSelector: Cast API is not installed!")},v6=
function(a,b){t6()?q6().setConnectedScreenStatus(a,b):o6("setConnectedScreenStatus called before ready.")},bKa=function(){var a=0<=g.Vc.search(/ (CrMo|Chrome|CriOS)\//);
return g.DA||a},kKa=function(a,b){q6().init(a,b)},cKa=function(a,b){var c=!1;
...
m6("cloudview.createSingleton_: "+c);return c},q6=function(){return g.Ha("yt.mdx.remote.cloudview.instance_")},dKa=function(a,b){p6(!0);
n6(!1);kKa(a,function(c){c?(gKa(!0),g.Io("yt-remote-cast2-api-ready")):(o6("Failed to initialize cast API."),p6(!1),g.Gu("yt-remote-cast-available"),g.Gu("yt-remote-cast-receiver"),eKa());b(c)})},m6=function(a){J5("cloudview",a)},o6=function(a){J5("cloudview",a)},p6=function(a){m6("setCastInstalled_ "+a);
g.Eu("yt-remote-cast-installed",a)},t6=function(){return!!g.Ha("yt.mdx.remote.cloudview.apiReady_")},gKa=function(a){m6("setApiReady_ "+a);
...
this.Ma=0;this.u=a;this.C=[];this.B=new oJa;this.l=this.i=null;this.L=(0,g.B)(this.dN,this);this.I=(0,g.B)(this.Ar,this);this.J=(0,g.B)(this.cN,this);this.W=(0,g.B)(this.kN,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.Vz,this),lKa(this))):c=3;0!=c&&(b?this.Vz(c):g.zo((0,g.B)(function(){this.Vz(c)},this),0));
var d=jKa();d&&D6(this,d);this.subscribe("yt-remote-cast2-session-change",this.W)},F6=function(a){return new w6(a.u.getPlayerContextData())},lKa=function(a){g.Ab("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange".split(" "),function(b){this.C.push(this.u.subscribe(b,g.Qa(this.yO,b),this))},a)},mKa=function(a){g.Ab(a.C,function(b){this.u.unsubscribeByKey(b)},a);
...
z6(d,c);-1E3!=d.playerState&&(d.playerState=b);I6(a,d)},K6=function(a,b,c){a.u.sendMessage(b,c)},I6=function(a,b){mKa(a);
a.u.setPlayerContextData(C6(b));lKa(a)},D6=function(a,b){a.l&&(a.l.removeUpdateListener(a.L),a.l.removeMediaListener(a.I),a.Ar(null));
a.l=b;a.l&&(J5("CP","Setting cast session: "+a.l.sessionId),a.l.addUpdateListener(a.L),a.l.addMediaListener(a.I),a.l.media.length&&a.Ar(a.l.media[0]))},nKa=function(a){var b=a.i.media,c=a.i.customData;
...
this.C=NaN;this.ca=!1;this.L=this.J=this.X=this.Y=NaN;this.W=[];this.B=this.I=this.u=this.Fb=this.i=null;this.ia=a;this.W.push(g.ap(window,"beforeunload",(0,g.B)(this.pL,this)));this.l=[];this.Fb=new w6;this.ga=b.id;this.ea=b.idType;this.i=oKa(this,c);this.i.subscribe("handlerOpened",this.hN,this);this.i.subscribe("handlerClosed",this.eN,this);this.i.subscribe("handlerError",this.fN,this);this.i.subscribe("handlerMessage",this.gN,this);this.i.Zu(b.token);this.subscribe("remoteQueueChange",function(){var d=
this.Fb.videoId;g.Hu()&&g.Eu("yt-remote-session-video-id",d)},this)},N6=function(a){J5("conn",a)},oKa=function(a,b){return new C5(G5(a.ia,"/bc"),b,!1,function(){return a.MB()},"shortLived"==a.ea)},O6=function(a,b){a.V("proxyStateChange",b)},pKa=function(a){a.C=g.zo((0,g.B)(function(){N6("Connecting timeout");
this.uo(1)},a),2E4)},P6=function(a){g.Bo(a.C);
a.C=NaN},Q6=function(a){g.Bo(a.Y);
a.Y=NaN},qKa=function(a){R6(a);
a.X=g.zo((0,g.B)(function(){S6(this,"getNowPlaying")},a),2E4)},R6=function(a){g.Bo(a.X);
a.X=NaN},sKa=function(a,b){b&&(P6(a),Q6(a));
var c=E5(a.i)&&isNaN(a.C);b==c?b&&(O6(a,1),S6(a,"getSubtitlesTrack")):b?(a.HD()&&a.Fb.reset(),O6(a,1),S6(a,"getNowPlaying"),rKa(a)):a.uo(1)},tKa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.Fb.videoId&&(g.Ob(b.params)?a.Fb.i=null:a.Fb.i=b.params,a.V("remotePlayerChange"))},uKa=function(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);
a.Fb.listId=b.params.listId||a.Fb.listId;B6(a.Fb,c,d);a.V("remoteQueueChange")},wKa=function(a,b){b.params=b.params||{};
uKa(a,b);vKa(a,b);a.V("autoplayDismissed")},vKa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
z6(a.Fb,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.Fb.playerState&&(c=-1E3);a.Fb.playerState=c;c=Number(b.params.loadedTime);a.Fb.W=isNaN(c)?0:c;c=Number(b.params.duration);a.Fb.I=isNaN(c)?0:c;c=a.Fb;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.Fb;d=Number(b.params.seekableStartTime);var e=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.l=isNaN(e)?0:e;1==a.Fb.playerState?qKa(a):R6(a);a.V("remotePlayerChange")},xKa=function(a,b){if(-1E3!=
a.Fb.playerState){var c=1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.Fb.playerState=c;c=parseInt(b.params.currentTime,10);z6(a.Fb,isNaN(c)?0:c);a.V("remotePlayerChange")}},yKa=function(a,b){var c="true"==b.params.muted;
a.Fb.volume=parseInt(b.params.volume,10);a.Fb.muted=c;a.V("remotePlayerChange")},zKa=function(a,b){a.I=b.params.videoId;
a.V("nowAutoplaying",parseInt(b.params.timeout,10))},AKa=function(a,b){var c="true"==b.params.hasNext;
a.Fb.bj="true"==b.params.hasPrevious;a.Fb.hasNext=c;a.V("previousNextChange")},rKa=function(a){g.Bo(a.L);
...
this.Hf=a;this.i=[];this.i.push(this.Hf.$_s("screenChange",(0,g.B)(this.TJ,this)));this.i.push(this.Hf.$_s("onlineScreenChange",(0,g.B)(this.fO,this)))},EKa=function(a,b){sIa();
if(!P4||!P4.get("yt-remote-disable-remote-module-for-dev")){b=g.P("MDX_CONFIG")||b;kIa();N4();U6||(U6=new F5(b?b.loungeApiHost:void 0),tIa()&&(U6.i="/api/loungedev"));V6||(V6=g.Ha("yt.mdx.remote.deferredProxies_")||[],g.Da("yt.mdx.remote.deferredProxies_",V6,void 0));BKa();var c=W6();if(!c){var d=new X5(U6);g.Da("yt.mdx.remote.screenService_",d,void 0);c=W6();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,disableCastApi:b.disableCastApi,
enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken});fKa(a,d,function(h){h?X6()&&v6(X6(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){B4("yt-remote-receiver-availability-change")})},e)}if(b&&!g.Ha("yt.mdx.remote.initialized_")){g.Da("yt.mdx.remote.initialized_",!0,void 0);
...
Z6.push(g.Go("yt-remote-cast2-session-change",CKa));Z6.push(g.Go("yt-remote-connection-change",function(h){h?v6(X6(),"YouTube TV"):a7()||(v6(null,null),iKa())}));
e=b7();b.isAuto&&(e.id+="#dial");g.Po("desktop_enable_autoplay")&&(e.capabilities=["atp"]);e.name=b.device;e.app=b.app;var f=b.theme;f&&(e.theme=f);Y6(" -- with channel params: "+g.Pj(e));e?(g.Eu("yt-remote-session-app",e.app),g.Eu("yt-remote-session-name",e.name)):(g.Gu("yt-remote-session-app"),g.Gu("yt-remote-session-name"));g.Da("yt.mdx.remote.channelParams_",e,void 0);c.start();X6()||DKa()}}},FKa=function(){var a=W6().Hf.$_gos();
var b=c7();b&&d7()&&(I4(a,b)||a.push(b));return jIa(a)},e7=function(){var a=GKa();
!a&&s6()&&hKa()&&(a={key:"cast-selector-receiver",name:hKa()});return a},GKa=function(){var a=FKa(),b=c7();
b||(b=a7());return g.cb(a,function(c){return b&&E4(b,c.key)?!0:!1})},c7=function(){var a=X6();
if(!a)return null;var b=W6().Pg();return J4(b,a)},CKa=function(a){Y6("remote.onCastSessionChange_: "+F4(a));
...
c7()&&c7();if(l7)f7=a;else{HKa(a.id);var c=new M6(U6,a,b7());c.connect(b,IKa());c.subscribe("beforeDisconnect",function(d){B4("yt-remote-before-disconnect",d)});
...
i7(c)}},DKa=function(){var a=a7();
a?(Y6("Resume connection to: "+F4(a)),h7(a,0)):(O4(),iKa(),Y6("Skipping connecting because no session screen found."))},BKa=function(){var a=b7();
...
var d=this;this.l=a;this.G=b;this.wb=c;this.events=new g.zN(this);this.X=this.events.N(this.G,"onVolumeChange",function(e){JKa(d,e)});
...
a=this.wb;a.na();a.subscribe("proxyStateChange",this.JF,this);a.subscribe("remotePlayerChange",this.Gr,this);a.subscribe("remoteQueueChange",this.Iu,this);a.subscribe("previousNextChange",this.GF,this);a.subscribe("nowAutoplaying",this.BF,this);a.subscribe("autoplayDismissed",this.bF,this);g.L(this,this.i);g.L(this,this.u);g.L(this,this.L);g.L(this,this.W);g.L(this,this.J);this.ZG();this.Iu();this.Gr()},JKa=function(a,b){if(n7(a)){a.wb.unsubscribe("remotePlayerChange",a.Gr,a);
var c=Math.round(b.volume),d=!!b.muted,e=F6(a.wb);if(c!==e.volume||d!==e.muted)a.wb.setVolume(c,d),a.W.start();a.wb.subscribe("remotePlayerChange",a.Gr,a)}},KKa=function(a){a.Bb(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.G.getVideoData(1);a.wb.playVideo(c.videoId,b,d,e,c.playerParams,c.ia,XHa(c));a.tb(new g.vK(1))},LKa=function(a,b){if(b){var c=a.G.getOption("captions","tracklist",{aE:1});
...
ba:"OK"}]}]}]});this.i=new g.eM(this,250);this.learnMoreButton=this.ha("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.ha("ytp-mdx-manual-pairing-popup-ok");g.L(this,this.i);this.N(this.learnMoreButton,"click",this.l);this.N(this.okButton,"click",this.u)},r7=function(){g.X.call(this,{D:"div",
...
{D:"div",K:"ytp-mdx-privacy-popup-buttons",S:[{D:"button",ka:["ytp-button","ytp-mdx-privacy-popup-cancel"],ba:"Annuler"},{D:"button",ka:["ytp-button","ytp-mdx-privacy-popup-confirm"],ba:"Confirmer"}]}]}]});this.i=new g.eM(this,250);this.cancelButton=this.ha("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.ha("ytp-mdx-privacy-popup-confirm");g.L(this,this.i);this.N(this.cancelButton,"click",this.l);this.N(this.confirmButton,"click",this.u)},s7=function(a){g.X.call(this,{D:"div",
K:"ytp-remote",S:[{D:"div",K:"ytp-remote-display-status",S:[{D:"div",K:"ytp-remote-display-status-icon",S:[g.Mma()]},{D:"div",K:"ytp-remote-display-status-text",ba:"{{statustext}}"}]}]});this.api=a;this.i=new g.eM(this,250);g.L(this,this.i);this.N(a,"presentingplayerstatechange",this.l);MKa(this,a.Wa())},MKa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
c=g.W(b,128)?g.UJ("Erreur sur $RECEIVER_NAME",c):b.Kb()||g.W(b,4)?g.UJ("Lecture sur $RECEIVER_NAME",c):g.UJ("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.Aa("statustext",c);a.i.show()}else a.i.hide()},t7=function(a,b){g.SQ.call(this,"Lire sur",0,a,b);
...
this.fi={key:H4(),name:"Cet ordinateur"};this.lh=null;this.subscriptions=[];this.wz=this.wb=null;this.Ml=[this.fi];this.al=this.fi;this.Mc=new g.vK(64);this.wE=0;this.Ne=-1;this.Xo=null;this.Jr=this.nu=!1;this.yn=this.pp=null;if(!g.TC(this.player.T())){a=this.player;var b=g.nN(a);b&&(b=b.an())&&(b=new t7(a,b),g.L(this,b));b=new s7(a);g.L(this,b);g.xN(a,b.element,4);this.pp=new r7;g.L(this,this.pp);g.xN(a,this.pp.element,4);g.U(this.player.T().experiments,"pair_servlet_deprecation_warning_enabled")&&
!g.U(this.player.T().experiments,"deprecate_pair_servlet_enabled")&&(this.Xo=new q7,g.L(this,this.Xo),g.xN(a,this.Xo.element,4));this.Jr=!!a7();this.nu=!!g.Fu("yt-remote-manual-pairing-warning-shown")}},v7=function(a){a.yn&&(a.player.removeEventListener("presentingplayerstatechange",a.yn),a.yn=null)},NKa=function(a,b,c){a.Mc=c;
a.player.V("presentingplayerstatechange",new g.AJ(c,b))},OKa=function(a,b,c){var d=!1;
1===b?d=!a.Jr:2===b&&(d=!a.nu);d&&g.CJ(c,8)&&(a.player.pauseVideo(),v7(a))},w7=function(a,b){if(b.key!==a.al.key)if(b.key===a.fi.key)g7();
else{if(a.Xo&&!a.nu&&b!==a.fi&&"cast-selector-receiver"!==b.key&&g.mD(a.player.T()))PKa(a);else{var c;(c=!g.U(a.player.T().experiments,"mdx_enable_privacy_disclosure_ui"))||(c=((c=g.P("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.P("SESSION_INDEX")&&!g.P("LOGGED_IN")))||a.Jr||!a.pp);(c?0:g.mD(a.player.T())||g.qD(a.player.T()))&&QKa(a)}a.al=b;var d=a.player.getPlaylistId();c=a.player.getVideoData(1);var e=c.videoId;if(!d&&!e||(2===a.player.getAppState()||1===a.player.getAppState())&&
...
t6()?q6().setLaunchParams(c):o6("setLaunchParams called before ready.")):!c&&j7()&&X6()==b.key?B4("yt-remote-connection-change",!0):(g7(),$6(c||null),c=W6().Pg(),(c=J4(c,b.key))&&h7(c,1))}},QKa=function(a){a.player.Wa().Kb()?a.player.pauseVideo():(a.yn=function(b){OKa(a,1,b)},a.player.addEventListener("presentingplayerstatechange",a.yn));
a.pp&&a.pp.Dc();d7()||(l7=!0)},PKa=function(a){a.player.Wa().Kb()?a.player.pauseVideo():(a.yn=function(b){OKa(a,2,b)},a.player.addEventListener("presentingplayerstatechange",a.yn));
a.Xo&&a.Xo.Dc();d7()||(l7=!0)},MIa={"\x00":"\\0",
"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},j5={"'":"\\'"},RKa={},fIa={VR:"atp",o1:"ska",n0:"que",vZ:"mus",n1:"sus",MV:"dsp",F0:"seq",ZY:"mic",MU:"dpa"},P4,L4="",zIa=uIa("loadCastFramework")||uIa("loadCastApplicationFramework"),BIa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
Y4.prototype.parse=function(a){return g.A.JSON.parse(a,void 0)};var $4=new g.am;g.u(DIa,g.Hl);b5.prototype.i=null;b5.prototype.getOptions=function(){var a;(a=this.i)||(a={},FIa(this)&&(a[0]=!0,a[1]=!0),a=this.i=a);return a};var x7;g.Ta(EIa,b5);x7=new EIa;g.k=c5.prototype;g.k.jm=null;g.k.yi=!1;g.k.Jp=null;g.k.HA=null;g.k.rp=null;g.k.Dp=null;g.k.Uk=null;g.k.Pl=null;g.k.zn=null;g.k.De=null;g.k.Ds=0;g.k.Ci=null;g.k.Cv=null;g.k.Ok=null;g.k.Zp=-1;g.k.JG=!0;g.k.Jm=!1;g.k.tw=0;g.k.Pu=null;var KIa={},f5={};g.k=c5.prototype;g.k.setTimeout=function(a){this.C=a};
g.k.ZP=function(a){a=a.target;var b=this.Pu;b&&3==o5(a)?b.Og():this.GH(a)};
g.k.GH=function(a){try{if(a==this.De)a:{var b=o5(this.De),c=this.De.I,d=this.De.getStatus();if(g.Ae&&!g.ce(10)||g.Ce&&!g.ae("420+")){if(4>b)break a}else if(3>b||3==b&&!g.ug&&!q5(this.De))break a;this.Jm||4!=b||7==c||(8==c||0>=d?this.i.ii(3):this.i.ii(2));k5(this);var e=this.De.getStatus();this.Zp=e;var f=q5(this.De);(this.yi=200==e)?(4==b&&h5(this),this.I?(LIa(this,b,f),g.ug&&this.yi&&3==b&&(this.B.ya(this.u,"tick",this.SP),this.u.start())):g5(this,f),this.yi&&!this.Jm&&(4==b?this.i.Ss(this):(this.yi=
...
g.k.SP=function(){var a=o5(this.De),b=q5(this.De);this.Ds<b.length&&(k5(this),LIa(this,a,b),this.yi&&4!=a&&e5(this))};
...
g.k.BP=function(){this.Jp=null;var a=g.Sa();0<=a-this.HA?(2!=this.Dp&&this.i.ii(3),h5(this),this.Ok=2,a5(18),i5(this)):OIa(this,this.HA-a)};
g.k.getLastError=function(){return this.Ok};g.Ta(m5,g.am);var VIa=/^https?$/i,SKa=["POST","PUT"];g.k=m5.prototype;
g.k.send=function(a,b,c,d){if(this.i)throw Error("[goog.net.XhrIo] Object is active with another request="+this.W+"; newUri="+a);b=b?b.toUpperCase():"GET";this.W=a;this.u="";this.I=0;this.za=b;this.ga=!1;this.B=!0;this.i=this.ea?GIa(this.ea):GIa(x7);this.ca=this.ea?this.ea.getOptions():x7.getOptions();this.i.onreadystatechange=(0,g.B)(this.HF,this);try{A4(p5(this,"Opening Xhr")),this.la=!0,this.i.open(b,String(a),!0),this.la=!1}catch(f){A4(p5(this,"Error opening Xhr: "+f.message));UIa(this,f);return}a=
c||"";var e=this.headers.clone();d&&bIa(d,function(f,h){e.set(h,f)});
d=g.cb(e.rh(),SIa);c=g.A.FormData&&a instanceof g.A.FormData;!g.fb(SKa,b)||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(f,h){this.i.setRequestHeader(h,f)},this);
this.Ca&&(this.i.responseType=this.Ca);"withCredentials"in this.i&&this.i.withCredentials!==this.ia&&(this.i.withCredentials=this.ia);try{XIa(this),0<this.J&&(this.Y=RIa(this.i),A4(p5(this,"Will abort after "+this.J+"ms if incomplete, xhr2 "+this.Y)),this.Y?(this.i.timeout=this.J,this.i.ontimeout=(0,g.B)(this.FB,this)):this.X=g.Lm(this.FB,this.J,this)),A4(p5(this,"Sending request")),this.L=!0,this.i.send(a),this.L=!1}catch(f){A4(p5(this,"Send error: "+f.message)),UIa(this,f)}};
...
g.k.HF=function(){this.na()||(this.la||this.L||this.C?WIa(this):this.AO())};
g.k.AO=function(){WIa(this)};
...
g.k.getLastError=function(){return"string"===typeof this.u?this.u:String(this.u)};g.k=YIa.prototype;g.k.uw=null;g.k.Cg=null;g.k.Qu=!1;g.k.VG=null;g.k.wt=null;g.k.Ny=null;g.k.ww=null;g.k.Ma=null;g.k.Nj=-1;g.k.aq=null;g.k.kq=null;g.k.connect=function(a){this.ww=a;a=r5(this.i,null,this.ww);a5(3);this.VG=g.Sa();var b=this.i.J;null!=b?(this.aq=b[0],(this.kq=b[1])?(this.Ma=1,ZIa(this)):(this.Ma=2,t5(this))):(y4(a,"MODE","init"),this.Cg=new c5(this,void 0,void 0,void 0),this.Cg.jm=this.uw,d5(this.Cg,a,!1,null,!0),this.Ma=0)};
...
g.k.HQ=function(a){a?a5(2):(a5(1),mJa(this,8))};
...
g.k.ii=function(a){var b=$4;b.dispatchEvent(new bJa(b,a))};
g.k.Yr=function(){return!(!g.Ae||g.ce(10))};
g.k=nJa.prototype;g.k.JC=function(){};
g.k.IC=function(){};
g.k.HC=function(){};
g.k.gx=function(){};
g.k.rD=function(){return{}};
g.k.isActive=function(){return!0};g.k=oJa.prototype;g.k.isEmpty=function(){return g.gb(this.i)&&g.gb(this.l)};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.If=5E3};g.Ta(C5,nJa);g.k=C5.prototype;g.k.subscribe=function(a,b,c){return this.u.subscribe(a,b,c)};
...
g.k.dispose=function(){this.X||(this.X=!0,g.Oi(this.u),rJa(this),g.Oi(this.l),this.l=null,this.Y=function(){return""})};
g.k.na=function(){return this.X};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.W="";this.l.stop();this.C=a||null;this.B=b||0;a=this.ca+"/test";b=this.ca+"/bind";var d=new u5(c?c.firstTestResults:null,c?c.secondTestResults:null,this.ea),e=this.i;e&&(e.yf=null);d.yf=this;this.i=d;D5(this);if(this.i){d=g.P("ID_TOKEN");var f=this.i.Ii||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.Ii=f}e?(3!=e.getState()&&0==hJa(e)||e.getState(),this.i.connect(a,b,this.I,e.l,e.So)):c?this.i.connect(a,
b,this.I,c.sessionId,c.arrayId):this.i.connect(a,b,this.I)}};
g.k.sendMessage=function(a,b){var c={_sc:a};b&&g.Xb(c,b);this.l.isActive()||2==(this.i?this.i.getState():0)?this.J.push(c):E5(this)&&(D5(this),gJa(this.i,c))};
g.k.JC=function(){this.l.reset();this.C=null;this.B=0;if(this.J.length){var a=this.J;this.J=[];for(var b=0,c=a.length;b<c;++b)gJa(this.i,a[b])}this.V("handlerOpened")};
...
g.k.IC=function(a){"S"==a[0]?this.W=a[1]:"gracefulReconnect"==a[0]?(this.l.start(),eJa(this.i)):this.V("handlerMessage",new pJa(a[0],a[1]))};
...
g.k.jQ=function(){this.l.isActive();0==hJa(this.i)&&this.connect(this.C,this.B)};F5.prototype.B=function(a,b,c,d){b?a(d):a({text:c.responseText})};
F5.prototype.u=function(a,b){a(Error("Request error: "+b.status))};
F5.prototype.C=function(a){a(Error("request timed out"))};var yJa=g.Sa(),I5=null,L5=Array(50),K5=-1,M5=!1;g.Ta(N5,g.R);N5.prototype.Pg=function(){return this.screens};
...
g.k.KJ=function(a){this.i=null;a.status&&404==a.status?this.l>=TKa.length?this.V("pairingFailed",Error("DIAL polling timed out")):(a=TKa[this.l],this.gb=g.zo((0,g.B)(this.dG,this),a),this.l++):this.V("pairingFailed",Error("Server error "+a.status))};
g.k.MJ=function(){this.i=null;this.V("pairingFailed",Error("Server not responding"))};
var TKa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ta(Q5,N5);g.k=Q5.prototype;g.k.start=function(){P5(this)&&this.V("screenChange");!g.Fu("yt-remote-lounge-token-expiration")&&CJa(this);g.Bo(this.i);this.i=g.zo((0,g.B)(this.start,this),1E4)};
g.k.add=function(a,b){P5(this);zJa(this,a);R5(this,!1);this.V("screenChange");b(a);a.token||CJa(this)};
g.k.remove=function(a,b){var c=P5(this);BJa(this,a)&&(R5(this,!1),c=!0);b(a);c&&this.V("screenChange")};
...
g.k.Hz=function(){g.Bo(this.u);this.u=NaN;this.l&&this.l.abort();var a=EJa(this);if(z4(a)){var b=G5(this.C,"/pairing/get_screen_availability");this.l=H5(this.C,b,{lounge_token:g.Jb(a).join(",")},(0,g.B)(this.UO,this,a),(0,g.B)(this.TO,this))}else V5(this,{}),W5(this)};
g.k.UO=function(a,b){this.l=null;var c=g.Jb(EJa(this));if(g.yb(c,g.Jb(a))){c=b.screens||[];for(var d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;V5(this,d);W5(this)}else this.Fd("Changing Screen set during request."),this.Hz()};
...
g.k.NJ=function(a,b,c,d){g.Yp(G5(this.B,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.B)(function(e,f){var h=new D4(f.screen||{});if(!h.name||IJa(this,h.name)){a:{var l=h.name;for(var m=2,n=b(l,m);IJa(this,n);){m++;if(20<m)break a;n=b(l,m)}l=n}h.name=l}c(Y5(this,h))},this),
...
g.k.BL=function(){KJa(this);this.V("screenChange");this.i.update()};
...
g.k.Sz=function(){};
g.k.da=function(){this.info("disposeInternal");SJa(this);this.l&&(this.l.removeUpdateListener(this.Y),this.l.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.ca));this.l=null;$5.prototype.da.call(this)};
g.k.GP=function(a,b){if(!this.na())if(b){var c=X4(b);if(g.Na(c)){var d=""+c.type;c=c.data||{};this.info("onYoutubeMessage_: "+d+" "+g.Pj(c));switch(d){case "mdxSessionStatus":MJa(this,c);break;case "loungeToken":PJa(this,c);break;default:b6(this,"Unknown youtube message: "+d)}}else b6(this,"Unable to parse message.")}else b6(this,"No data in message.")};
g.k.ID=function(a,b,c,d){g.Bo(this.L);this.L=0;HJa(this.u,this.i.label,a,this.i.friendlyName,(0,g.B)(function(e){e?b(e):0<=d?(b6(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.L=g.zo((0,g.B)(this.ID,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){ZJa(this);this.l?this.l.stop((0,g.B)(this.cg,this,null),(0,g.B)(this.cg,this,"Failed to stop DIAL device.")):this.cg()};
g.k.da=function(){ZJa(this);this.l&&this.l.removeUpdateListener(this.Y);this.l=null;$5.prototype.da.call(this)};
...
g.k.da=function(){this.l.unsubscribe("onlineScreenChange",(0,g.B)(this.KB,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.I);var a=sJa,b=g.Ha("yt.mdx.remote.debug.handlers_");g.kb(b||[],a);g.Oi(this.i);g.R.prototype.da.call(this)};
...
this.V("yt-remote-cast2-session-change",this.i.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.Fd('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);l6(this,new f6(this.l,b,this.C,this.B))}b=this.i;b.J=a;b.J.appState==chrome.cast.DialAppState.RUNNING?(a=b.J.extraData||{},c=a.screenId||null,TJa(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=XJa(b,{name:b.i.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.J.receiver.label,
screenIdType:"shortLived"}):(g.wo(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=YJa(b,c)):a=YJa(b,c)):a=g6(b);return a};
...
g.k.KB=function(){this.na()||(this.u=aKa(this),j6("Updating custom receivers: "+g.Pj(this.u)),chrome.cast.setCustomReceivers(this.u,g.Ia,(0,g.B)(function(){this.Fd("Failed to set custom receivers.")},this)),this.V("yt-remote-cast2-availability-change",k6(this)))};
...
g.k.da=function(){mKa(this);this.u=null;this.B.clear();D6(this,null);g.R.prototype.da.call(this)};
...
g.k.Ar=function(a){J5("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.J);if(this.i=a)this.i.addUpdateListener(this.J),nKa(this),this.V("remotePlayerChange")};
g.k.cN=function(a){a?(nKa(this),this.V("remotePlayerChange")):this.Ar(null)};
g.k.mA=function(){K6(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.kN=function(){var a=jKa();a&&D6(this,a)};
...
params:g.Pj(l)},a,nIa())}else N6("Connecting without params"),this.i.connect({},a,nIa());pKa(this)};
...
sKa(this,a);break;case "loungeScreenDisconnected":g.lb(this.l,function(c){return"LOUNGE_SCREEN"==c.type});
sKa(this,!1);break;case "remoteConnected":var b=new C4(X4(a.params.device));g.cb(this.l,function(c){return b?c.id==b.id:!1})||YHa(this.l,b);
break;case "remoteDisconnected":b=new C4(X4(a.params.device));g.lb(this.l,function(c){return b?c.id==b.id:!1});
break;case "gracefulDisconnect":break;case "playlistModified":uKa(this,a);break;case "nowPlaying":wKa(this,a);break;case "onStateChange":vKa(this,a);break;case "onAdStateChange":xKa(this,a);break;case "onVolumeChanged":yKa(this,a);break;case "onSubtitlesTrackChanged":tKa(this,a);break;case "nowAutoplaying":zKa(this,a);break;case "autoplayDismissed":this.V("autoplayDismissed");break;case "autoplayUpNext":this.I=a.params.videoId||null;this.V("autoplayUpNext",this.I);break;case "onAutoplayModeChanged":this.B=
a.params.autoplayMode;this.V("autoplayModeChange",this.B);"DISABLED"==this.B&&this.V("autoplayDismissed");break;case "onHasPreviousNextChanged":AKa(this,a);break;case "requestAssistedSignIn":this.V("assistedSignInRequested",a.params.authCode);break;default:N6("Unrecognized action: "+a.action)}};
...
g.k.uo=function(a){N6("Disconnecting with "+a);P6(this);this.V("beforeDisconnect",a);1==a&&O4();rJa(this.i,a);this.dispose()};
...
g.k.oQ=function(a,b){S6(this,a,b);rKa(this)};
...
g.k.ON=function(){g.Ob(this.B)||LKa(this,this.B);this.C=!1};
...
break;case -1:this.tb(new g.vK(64));break;case -1E3:this.tb(new g.vK(128,{errorCode:"mdx.remoteerror",errorMessage:"Cette vid\u00e9o ne peut pas \u00eatre visionn\u00e9e \u00e0 distance."}))}a=F6(this.wb).i;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.B=a,LKa(this,a));a=F6(this.wb);-1===a.volume||Math.round(this.G.getVolume())===a.volume&&this.G.isMuted()===a.muted||this.W.isActive()||this.wH()}else KKa(this)};
g.k.GF=function(){this.G.V("mdxpreviousnextchange")};
g.k.Iu=function(){n7(this)||KKa(this)};
...
g.k.wH=function(){var a=this;if(n7(this)){var b=F6(this.wb);this.events.Gb(this.X);b.muted?this.G.mute():this.G.unMute();this.G.setVolume(b.volume);this.X=this.events.N(this.G,"onVolumeChange",function(c){JKa(a,c)})}};
...
g.k.tb=function(a){this.u.stop();var b=this.I;if(!g.AK(b,a)){var c=g.W(a,2);c!==g.W(this.I,2)&&this.G.Bn(c);this.I=a;NKa(this.l,b,a)}};g.u(q7,g.X);q7.prototype.Dc=function(){this.i.show()};
...
r7.prototype.u=function(){B4("mdx-privacy-popup-confirm");this.kb()};g.u(s7,g.X);s7.prototype.l=function(a){MKa(this,a.state)};g.u(t7,g.SQ);t7.prototype.C=function(){var a=this.G.getOption("remote","receivers");a&&1<a.length&&!this.G.getOption("remote","quickCast")?(this.Ml=g.Bb(a,this.i,this),g.UQ(this,g.Pc(a,this.i)),a=this.G.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.gh(a),this.enable(!0)):this.enable(!1)};
t7.prototype.i=function(a){return a.key};
t7.prototype.Mh=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.Ml[a].name};
...
g.k.load=function(){this.player.cancelPlayback();g.HN.prototype.load.call(this);this.lh=new m7(this,this.player,this.wb);var a=(a=IKa())?a.currentTime:0;var b=j7()?new E6(d7(),void 0):null;0==a&&b&&(a=A6(F6(b)));0!==a&&this.Bb(a);NKa(this,this.Mc,this.Mc);this.player.Cj(6)};
...
g.k.IF=function(){var a=[this.fi],b=a.concat,c=FKa();s6()&&g.Fu("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Ml=b.call(a,c);a=e7()||this.fi;w7(this,a);this.player.xa("onMdxReceiversChange")};
