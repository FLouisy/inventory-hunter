var libJsLeadPlace = {
  ...
  SendtoLPbyIframe: function (_param) {
    ...
    _ifr.__tcfapi('getTCData', 2, function (tcData, success) {
      var sendTag = false;
      var gdprQs = '';
      ...
      // the case of IAB
      if (success && tcData.vendor && tcData.vendor.consents[libJsLeadPlace._vendorTemelioId] && tcData.purpose && tcData.purpose.consents[1] ) {
        ...
        var gdprQs = "gdpr=" + gdprApplies + "&gdpr_consent=" + consentData + "&";
